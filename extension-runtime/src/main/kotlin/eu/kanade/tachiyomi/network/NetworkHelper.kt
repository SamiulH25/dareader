...
//    private val cacheSize = 5L * 1024 * 1024 // 5 MiB
    ...
    private val httpCache: Cache by lazy {
        val dir = File(context.cacheDir, "network").apply { mkdirs() }
        Cache(directory = dir, maxSize = 5L * 1024 * 1024) // 5 MiB
    }
    ...
    private val baseClientBuilder: OkHttpClient.Builder
        get() {
            ...
            // Verbose HTTP logging is opt-in via DAREADER_HTTP_LOG=1; default stays BASIC.
            val httpLoggingInterceptor =
                HttpLoggingInterceptor(
                    ...
                    level =
                        if (System.getenv("DAREADER_HTTP_LOG") == "1") {
